-- Import plateb: Bednaříková Edita (fix – robustnější dohledání smlouvy)
-- Důvod: 020 mohla vložit 0 řádků, pokud se jméno v DB liší (např. "Edita Bednaříková").
-- Migrace je idempotentní přes NOT EXISTS (duplicitní záznamy nevloží).
